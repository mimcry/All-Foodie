...
const additem = ()=>{
  ...
  return (
    <div> 
      ...
      <Fooditem 
name="Sandwich"
image="https://img.freepik.com/premium-photo/homemade-grilled-cheese-sandwich-breakfast_2829-10567.jpg?w=1060"
category="Visit the various types of Sandwichs"/>
      </Button>
      <Modal
        open={open}
        onClose={handleClose}
