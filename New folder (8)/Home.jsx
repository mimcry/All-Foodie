...
// import Momoitem from '../components1/categoryitem/Momoitem';

// import Burgeritem from '../components1/categoryitem/Burgeritem';
// import Khajasetitem from '../components1/categoryitem/Khajasetitem'
// import Pizzaitem from '../components1/categoryitem/Pizzaitem'
// import Chickenitem from '../components1/categoryitem/Chickenitem'
// import Coffeeitem from '../components1/categoryitem/Coffeeitem'
// import Sandwichitem from '../components1/categoryitem/Sandwichitem'
// import Parothaitem from '../components1/categoryitem/Parothaitem'
// import Chowmeinitem from '../components1/categoryitem/Chowmeinitem'
// import Briyaniitem from '../components1/categoryitem/Briyaniitem'
// import Colddrinksitem from '../components1/categoryitem/Colddrinksitem'
export default function Home() {
  const chef = useRef(null);

  const seeallfood = () => {
    chef.current?.scrollIntoView({behavior: 'smooth'});
  };
  return (
          ...
          <Col lg="6" md="6">
            <div className="mt-5  hero__content">
              <h1 className="mb-4 hero__title">
               Giving your <span>HUNGRY</span> <br /> a <span>New</span> Option
              </h1>
              <p>
              ...
              <div className="hero__btns">
                <div className="hero__btns d-flex align-items-center gap-5 mt-4">
                  <button className="order__btn d-flex align-items-center justify-content-between" onClick={seeallfood}>
          ...
          <Row>
            ...
            <Col lg="6" md="6">
              <div className="why__foodie">
                <h2 className="foodie-title mb-4" ref={chef}>
